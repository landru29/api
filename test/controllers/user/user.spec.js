    ...
    describe('User: Controller', function() {
        ...
        describe('#readUsers', function() {
            it('Should read a user', function(done) {
                return testFrame().controllers.user.readUsers().then(
                    function(users) {
        ...
        describe('#readUserById', function() {
            ...
            it('Should not read any user (not existing id)', function(done) {
                return testFrame().controllers.user.readUserById(123).then(function() {
            ...
            it('Should not read any user (bad id)', function(done) {
                return testFrame().controllers.user.readUserById('bob').then(function() {
                    done('Should not resolve');
                }, function() {
                    done();
                });
        ...
        describe('#deleteUser', function() {
            ...
            it('Should not delete any user (not existing id)', function(done) {
                return testFrame().controllers.user.deleteUser(123).then(function() {
                    done('Should not resolve');
                }, function() {
                    done();
                });
            ...
            it('Should not delete any user (bad id)', function(done) {
                return testFrame().controllers.user.deleteUser('bob').then(function() {
                    done('Should not resolve');
                }, function() {
                    done();
                });
